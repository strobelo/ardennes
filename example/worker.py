...
@app.consume(JobCompleteSection)
def consume_job_section_complete(job_complete: JobCompleteSection):
    print(f"User function consume_job_section_complete: Got {job_complete}")
